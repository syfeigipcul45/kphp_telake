...
<form action="{{ route('dashboard.page.rph.update', $rph->id) }}" method="POST" enctype="multipart/form-data">
    @csrf
    ...
    <div class="row">
        <div class="col-xl-8 col-lg-7">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <div class="form-group">
                        <input type="text" class="form-control" name="name" value="{{ old('name', $rph->name) }}" />
                        @error('name')
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <textarea id="content-submenu" name="content">{{ old('content', $rph->content) }}</textarea>
                    @error('content')
                    <small class="form-text error-input">{{ $message }}</small>
                    @enderror
                </div>
