...
<form action="{{ route('dashboard.page.depts.update', $dept->id) }}" method="POST" enctype="multipart/form-data">
    @csrf
    ...
    <div class="row">
        <div class="col-xl-8 col-lg-7">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <textarea id="content-submenu" name="content">{{ old('content', $dept->content) }}</textarea>
                    @error('content')
                    <small class="form-text error-input">{{ $message }}</small>
                    @enderror
                </div>
