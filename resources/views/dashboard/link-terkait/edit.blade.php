    ...
    <div class="row">
        <div class="col-xl-8 col-lg-7">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <div class="form-group">
                        <input type="text" class="form-control" name="nama_link" value="{{ old('nama_link', $link->nama_link) }}" />
                        @error('nama_link')
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <div class="form-group">
                        <input type="text" class="form-control" name="url_link" value="{{ old('url_link', $link->url_link) }}" />
                        @error('url_link')
                        <small class="form-text error-input">{{ $message }}</small>
                        @enderror
                    </div>
