    ...
    <div class="row">
        <div class="col-xl-8 col-lg-7">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <textarea id="content-news" name="content">{{ old('content', $news->content) }}</textarea>
                    @error('content')
                    <small class="form-text error-input">{{ $message }}</small>
                    @enderror
                </div>
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex align-items-center justify-content-between">
                        ...
                        <div class="custom-control custom-switch">
                            <input type="checkbox" id="status" class="custom-control-input" {{ $news->is_published == 1 ? 'checked' : '' }} />
                            <input type="hidden" id="status-value" name="is_published" value="{{ old('is_published', $news->is_published) }}" />
